...
이 프로젝트는 인포그랩 블로그의 [n8n으로 DevOps·AI 콘텐츠 자동 수집·요약 (2025-12-17)](https://insight.infograb.net/blog/2025/12/17/n8n-devops-contents/) 글을 거의 그대로 벤치마크한 것이다. 차이는 다음 정도:

- **채널 5~10개로 출발** (원글의 40개 대신 PoC 규모)
- **도메인 3축**: AI/LLM · DevOps/인프라/클라우드 · 한국 IT/채용/스타트업
- **Slack Bot Token** 사용 (Webhook 대신 — 권한 확장·Block Kit 활용)
- **로드맵에 LangGraph 이식 단계 포함** — Week 1 가치 검증 후 Python 코드로 옮길지 판단
